...
public class MiniResultSet implements ResultSet {
    ...
    public Object getObject(String columnLabel) throws SQLException {
        ...
        if (!rows.get(currentRow).containsKey(columnLabel)) {
    ...
    // The following methods are required by the ResultSet interface but not implemented
    // for this minimal example. They all throw SQLFeatureNotSupportedException.
